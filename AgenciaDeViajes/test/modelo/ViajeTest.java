...
public class ViajeTest {
    ...
    public void testViajeFamiliar() throws ParseException {
        ...
        ViajeFamiliar viaje = new ViajeFamiliar("Popayán", "Bogotá", 1250000, new SimpleDateFormat("dd/MM/yyyy").parse("01/05/2019"), 
    ...
    public void testViajeIncentivo() throws ParseException {
        ...
        ViajeIncentivo viaje = new ViajeIncentivo("Popayán", "Medellin", 2100000, new SimpleDateFormat("dd/MM/yyyy").parse("03/06/2019"), 
    ...
    public void testViajeIndividual() throws ParseException {
        ...
        Viaje viaje = new ViajeIndividual("Popayán", "San Andres", 4250000, new SimpleDateFormat("dd/MM/yyyy").parse("01/07/2019"),
    ...
    public void testViajeTodoIncluido() throws ParseException {
        ...
        Viaje viaje = new ViajeTodoIncluido("Popayán", "Cartagena", 7350000, new SimpleDateFormat("dd/MM/yyyy").parse("01/07/2019"), 
                new SimpleDateFormat("dd/MM/yyyy").parse("12/07/2019"));
        assertEquals("Popayán", viaje.getOrigen());
